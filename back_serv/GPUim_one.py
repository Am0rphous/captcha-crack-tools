...
class_names = 'palm.names'
weights_file = 'yolov3_10000.weights'
size = 416
...
def gg(img, tp):
        if img.shape[0] != 100:
                ...
                boxeS, scores, labels = cpu_nms(B, C, len(classes), max_boxes=3000, score_thresh=0.002, iou_thresh=0.003) #Bike
