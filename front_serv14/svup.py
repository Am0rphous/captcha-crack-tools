...
mgDC = ["mountains",
               ...
               "tractors",
               "taxi",
               "bridges", "boats", "sculptures", "trees", "bicycles3"]
"""
# База данных
...
class ImageWebSocket(tornado.websocket.WebSocketHandler):
    ...
    def on_message(self, message):
                ...
                #print ("DONE") #, ms["Done"])#list(ms.keys())[0] == "Done")#list(ms.keys())[0] == "Done")
        ...
        if int(data_json["type"]) != 4:
                if data_json["st"] == "prep":
                        ...
                        for u in list_coll_temp:
                           ...
                           #new.create_collection("collection")
                           #new.del_one_post(ObjectId(u["_id"]))
...
#                           except KeyError:
#                                list_to_del.append(u)
#                        print (len(list_to_load), len(list_to_del))
#                        for ix in list_to_load:
#                            print (ix)
#                            #new.create_collection("collection")
#                            #new.del_one_post(ObjectId(ix["_id"]))
