             ...
             for ix, ops in enumerate(resize_fps16):
                ...
                if t % FRAME_PER_ACTION == 0:
                    if random.random() <= epsilon:
                        ...
                        class_index = np.argmax(readout_t[2:])
                        print ("----------Action----------", action_index, class_index, "<<<<>>>>", readout_t)
                        #a_t[action_index] = 1
                        #a_t[class_index] = 1
                        a_t_a = a_t[:2]
                        a_t_c = a_t[2:]
                        a_t_a[action_index] = 1
                        a_t_c[action_index] = 1
                ...
                r_t, terminal = gameaction(a_t, resize_label[ix], resize_class)
                #if ix>0:
