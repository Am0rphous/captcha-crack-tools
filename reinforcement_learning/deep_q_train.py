...
REPLAY_MEMORY = 2000#50000 # number of previous transitions to remember \ количество предыдущих переходов для запоминания
...
def readdata():
            lists = ["data/bicycles4x4/big_img.csv"] #"data/taxi4x4/big_img.csv", 
            for jk in lists:
                clas = jk.split("/")[1]
                print (clas)
